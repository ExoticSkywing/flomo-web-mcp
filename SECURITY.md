...
`flomo-web-mcp` uses your own flomo Web session credentials. Treat `FLOMO_AUTHORIZATION`, `FLOMO_COOKIE`, MCP client config, logs, and synchronized memo data as sensitive.
